...
def f1_value(r_percent, a_value):
    """Get f1 value from Roll Pressure Function chart (embedded image)"""
    # Make sure the PNG exists, or recreate from base64
    f1_img = ensure_image_file("Roll pressure function",
                               ROLL_PRESSURE_IMG_BASE64)
...
def f2_value(r_percent, a_value):
    """Get f2 value from Roll Torque Function chart (embedded image)"""
    # Make sure the PNG exists, or recreate from base64
    f2_img = ensure_image_file("Roll Torque function",
                               ROLL_TORQUE_IMG_BASE64)
    return _ensure_curve_value(
