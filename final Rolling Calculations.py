...
# =============================================================================
# f1/f2: load from your local images via a one-time matplotlib digitization
# =============================================================================

# --- Your local directory and basenames ---
...
def _digitize_curves(image_path: Path, label: str, reductions_grid: np.ndarray, a_values: np.ndarray) -> np.ndarray:
    ...
    for a in a_values:
        ...
        ys_val = _px_to_val(ys_px, ypx0, ypx1, yv0, yv1)  # ensure calibration matches your axis orientation
...
def _load_or_build_tables() -> None:
    ...
    cache = CHART_DIR / "f_tables.npz"  # save next to your images
    if cache.exists():
